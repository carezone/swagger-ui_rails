...
function program11(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "' class='parameter' minlength='0' name='";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.handleFileUpload = function(map, form) {
      ...
      obj.on = {
        error: function(data, textStatus, error) {
          return _this.showErrorStatus(data, _this);
        },
        response: function(data) {
          _this.showResponse(data, _this);
          return _this.showCompleteStatus(data, _this);
        }
      };
    ...
    OperationView.prototype.requestAsCurl = function(url, contentType) {
      return _.escape("curl -v -X " + this.model.method.toUpperCase() + this.getHeadersForCurl(contentType) + " \"" + url + "\"" + this.getBodyForCurl() + this.getFormForCurl());
    };
